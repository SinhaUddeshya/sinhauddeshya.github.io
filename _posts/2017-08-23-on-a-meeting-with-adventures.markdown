...
<p> It was suggested by our instructors to get in touch with students from the software testing class for testing the Web Application. Unfortunately, none of the testers who were initially interested performed any kind of testing on our websites and we didn't incorporate automated testing due to time constraints. As for me, programming isn't my strong suit, so for ensuring good quality of coding, I used an online tool called JSLint which proved to be very helpful in this scenario. I wasn't great at documenting the code but I managed to put some information about the code.</p><br><br>
